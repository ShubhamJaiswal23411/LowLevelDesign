...
@Slf4j
public class KingWheatBurgerFactory implements BurgerFactory{

    public KingWheatBurgerFactory() {
        log.info("Welcome to king wheat burger factory , this factory creates burgers with wheat buns");
    }
